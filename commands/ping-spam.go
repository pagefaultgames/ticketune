...
var pingSpamMessage = "**Please keep in mind that Helpers real people volunteering on their free time, so please don't ping them over and over.**\n" +
	"**When someone is free, they'll reach out to help you, but until then, please be patient and wait until someone get back to you.**\n\n" +
	"To be more precise, there is currently a colossal amount of 3 people helping on these tickets, all of them also working on other things for the project and having real life on the side.\n" +
