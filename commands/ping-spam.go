...
var pingSpamMessage = "**Please keep in mind that Helpers real people volunteering on their free time, so please don't ping them over and over.**\n" +
	...
	"To be more precise, there is currently a colossal amout 3 people helping on these tickets, all of them also working on other things for the project and having real life on the side.\n" +
